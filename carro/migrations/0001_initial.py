# Generated by Django 4.2.1 on 2023-05-24 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carro', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='carro.carro')),
            ],
        ),
        migrations.AddField(
            model_name='carro',
            name='categoria',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='carro.categoria'),
        ),
        migrations.AddField(
            model_name='carro',
            name='marca',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='carro.marca'),
        ),
    ]
