...
-- Copiando estrutura do banco de dados para revenda
CREATE DATABASE IF NOT EXISTS `revenda` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `revenda`;
...
-- Copiando dados para a tabela revenda.auth_user: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela revenda.carro_banner: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela revenda.carro_carro: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela revenda.carro_carroimage: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela revenda.django_admin_log: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela revenda.django_session: ~1 rows (aproximadamente)
